...
if __name__=="__main__":
    ...
    parser.add_argument('--input', type=str, default="demo/B6-8-23-10-46-t.mp4", help='test imgs folder or video or camera')
    ...
    parser.add_argument('--classes', nargs='+', default=(),type=int, help='filter by class: --class 0, or --class 0 2 3')
